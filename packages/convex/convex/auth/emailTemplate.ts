...
export function renderVerificationEmailTemplate(props: VerificationEmailProps): string {
...
<body style="font-family: ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #374151; margin: 0; padding: 0; background-color: #f9fafb;">
  <div style="max-width: 600px; margin: 0 auto; padding: 32px 24px; background-color: #ffffff;">
    ...
    <p style="font-size: 16px; color: #374151; margin-bottom: 24px;">
      Please enter the following verification code to complete your account setup and start using ${appName}.
    </p>
    ...
    <p style="font-size: 14px; color: #6b7280; margin-bottom: 16px;">
      If you didn't request this verification code, you can safely ignore this email. Your account won't be created without verification.
    </p>
