...
| F3.3.3  | Validacion JSON + trazas completas en runs                                | ✅     | validate_json + auto-finalize + trazas exportables con output final     | packages/convex/convex/agents/core/tools/validate_json.ts; packages/convex/convex/agents/core/json_utils.ts; packages/convex/convex/agents/core/agent_loop.ts; packages/convex/convex/agents/agentRuns.ts; packages/convex/convex/agents/domainMap.ts; apps/webapp/src/domains/products/components/agent-progress.tsx; apps/webapp/src/domains/products/components/domain-map-card.tsx; apps/webapp/src/routes/settings/product/$slug/context.tsx; apps/webapp/src/i18n/locales/en/products.json; apps/webapp/src/i18n/locales/es/products.json |
